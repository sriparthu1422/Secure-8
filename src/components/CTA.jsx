    ...
    return (
        <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="bg-cyber-800/80 backdrop-blur-md border border-cyber-700/50 p-6 sm:p-8 md:p-10 lg:p-16 rounded-3xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-8 box-glow">
